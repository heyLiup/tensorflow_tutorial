...
$label = "BCEF";//BCEFGHJKMPQRTVWXY2346789
if(isset($_GET["label"])){
	$label = $_GET["label"];
}
$code = new seccode();
...
$code->width = 100;
$code->height = 30;
$code->background = 0;//Ëæ»úÍ¼Æ¬±³¾°
$code->adulterate = 0;//Ëæ»ú±³¾°Í¼ÐÎ
$code->ttf = 0;//Ëæ»úttf×ÖÌå
$code->angle = 0;//Ëæ»úÇãÐ±¶È
$code->warping = 0;//Ëæ»úÅ¤Çú
$code->scatter = 0;//Í¼Æ¬´òÉ¢
$code->color = 0;//Ëæ»úÑÕÉ«
$code->size = 0;//Ëæ»ú´óÐ¡;
$code->shadow = 0;//ÎÄ×ÖÒõÓ°
$code->animator = 0;//gif¶¯»­
$code->fontpath = 'seccode/font/';
